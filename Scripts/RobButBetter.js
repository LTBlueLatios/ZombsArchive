...
// @namespace    -
// @version      v1
// @description  send alt part of this is patched
// @author       me
// @match        zombs.io
// @grant        none
...
// @downloadURL https://update.greasyfork.org/scripts/435124/%F0%9D%94%90%F0%9D%99%A4%E0%BB%93%20but%20better.user.js
// @updateURL https://update.greasyfork.org/scripts/435124/%F0%9D%94%90%F0%9D%99%A4%E0%BB%93%20but%20better.meta.js
// ==/UserScript==
...
if (localStorage.loadReminder == undefined) {
    ...
    alert(
        ' if u report this I will delete it and u will not have it anymore '
    )
...
const authors = "me of course hahaaaaa";
...
addEventListener('keydown', function (e) {
    ...
    if (e.key == "u" && !_isInChatbox) {
        ...
        game.ui.getComponent("PopupOverlay").showHint(
            'Press z for auto bow, x for auto upgrade all, u for auto accepter, k for auto clear chat and n for speed run',
            1.5e4
        )
    }
})
