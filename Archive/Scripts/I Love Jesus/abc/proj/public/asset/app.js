                ...
                if (!document.useRequiredEquipment) {
                    ...
                    if (!document.already81) {
                        ...
                        document.getElementsByClassName("hud-Scripts-grid")[0].innerHTML = `
                            <div style="text-align:center; background-image: url('https://tse4.mm.bing.net/th?id=OIP.i82cCwt-CFPn-nSou3Hv2QHaEK&pid=Api&P=0&h=180'); background-size: cover;">
                                <div class="mainxgrid">
                                    <h3>~ Main ~</h3>
                                    <hr />
                                ...
                                <div class="mainzgrid">
                                    ...
                                    <div class="mainzskripts">
                                        ...
                                        <hr />
                                        <button class="btn btn-blue Z3" style="width: 49.5%; background-color:rgb(255, 0, 0); color: white;" onclick="enableRegularMousemove()">Enable Regular Mousemove</button>
                                ...
                                <div class="mainssgrid" style="display: none;">
                                    ...
                                    <div class="mainsskripts">
                                        <!-- Add your server scanner scripts here -->
                                    </div>
                                </div>
                            </div>
                        `;
                        ...
                        let added = false;
                        let added2 = false;
                        const mapTexture = PIXI.Texture.from(`http://localhost/asset/pictures/map-grass.png`);
                        let grassTexture;
                        const lines = [];
                        ...
                        const add200x200Grid = () => {
                            ...
                            grassTexture.x = 48;
                            grassTexture.y = 48;
                            grassTexture.width = 240000;
                            grassTexture.height = 240000;
